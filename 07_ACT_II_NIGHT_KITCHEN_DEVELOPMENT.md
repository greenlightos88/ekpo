...
subsequent kitchen confrontation.
...
- recognized Kai at the regulator
- registered all three sons at the river
- observed Malik's vigilance, Ade's failed humor, and Kai's attention
- followed the displaced talisman's relationship into the compound

It has not yet demonstrated:

- sustained human impersonation
- biographical memory
- physical injury
- objective architectural change
- a stable visible body
- a complete psychological attack

## Sequence VIII transition
...
The kitchen permits one additional material event:

- the empty brass urn resonates
- the concealed talisman gives a smaller answer

No other object moves. No figure appears. No one is touched or injured.

---

# Red-corded door

The red-corded door is physically present in the Oku family house before the
shrine breach and behaves normally.
...
Night, after the river ceremony and return to the compound.

The three brothers sleep in the same room beneath mosquito nets. Kai's camera
bag and talisman remain near his bed. Malik keeps the empty urn in its padded
case.
...
Knows only that his body registered an unseen presence at the river.

### Ade

Suspects the brothers shared the river's silence but has not asked.

### Kai

Knows the shrine breach caused the river response and continues concealing the
talisman.

### Bode

Knows the river became unsafe. Does not yet know Kai reached the regulator.
...
Turn: He chooses physical intervention and stops Kai.

Residue: `We are done pretending separately` establishes his new moral role.

### Kai

Objective: Repair what he opened without surrendering the talisman or admitting
the breach.
...
- Supernatural progression: PASS - first Attachment probes only
- Cultural behavior: WORKING PASS
...
1. Bode is awake in the kitchen with a kettle and clean cloth.
2. The brothers enter together carrying the empty urn and concealed talisman.
3. Each brother gives one exact fact about his encounter.
4. Bode asks what Kai opened.
5. Kai repeats the incomplete account of his fall.
6. The empty urn produces one impossible brass note.
7. A smaller answer comes from Kai's camera bag.
8. Bode orders the bag onto the table.
9. He finds the snapped red thread caught beneath its flap.
10. He reconstructs the surviving knot between his fingers.
11. The knot's workmanship tells him where Kai went.
12. Kai opens the bag himself and reveals the talisman.
13. Bode confirms Kai removed it and did not put it back.
...
Objective: Establish cause and responsibility.

Pressure: Kai's omission has become danger inside the bed beside him.

Residue: Protection and punishment begin competing.

### Ade

Objective: Keep truth moving without allowing Malik and Kai to rupture.

Pressure: Humor can no longer ventilate the room safely.

Residue: Ade becomes the family's first active mediator.

### Kai

Objective: Preserve interpretive control over the talisman.

Pressure: The objects expose him before he chooses confession.

Residue: He reveals the talisman himself but has not surrendered it emotionally.

### Bode

Objective: Determine whether an inherited boundary was breached.

Pressure: The knot proves the failure he feared.

Residue: Continued silence would now be culpable.
...
- begin with kettle, cloth, and Bode's wakefulness
- let the urn sound before revealing why
- discover red thread at the same time as Bode
- remain on Bode's fingers while debris becomes a recognizable knot
- do not use a shrine flashback
- Kai must place the talisman on the table himself

### Sound

- one clear urn note
- one dull response from the camera bag
- no score beneath the knot reconstruction
- dogs at the end mark distance rather than approach
- Eno relighting the burner restores human agency and ordinary sound
...
Bode reconstructs a snapped red knot beside Solomon's empty urn while Kai
places the stolen talisman between them.
