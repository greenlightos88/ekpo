...
Current dramatic endpoint: Sequence 26 — `A WAY HOME`. Verified producer length: **100 physical pages: one title page + 99 screenplay pages**; `PROJECT_MANIFEST.yaml` records the same count. The expanded creator-authorized regression suite currently checks 35 screenplay/continuity conditions.
