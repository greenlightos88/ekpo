...
Psychological supernatural family drama about inheritance.
...
The next movement must deepen practical consequence and family choice before adding cosmological explanation.

Do not yet reveal the full cause of the sister's death, appoint Malik/Kai, open the inner door for spectacle, or turn the records into a repair manual.
...
See `AGENTS.md` for repository operating rules.
